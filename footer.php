      ...
      <div class="footer_body">
        <div class="footer_logo">
              <a class="logo" href="<?php echo esc_url(home_url('/')); ?>">
                <img src="<?php echo get_template_directory_uri(); ?>/assets/img/logo-white.svg" alt="ogawa-yasuhiro-logo">
              </a>
        </div>
        <nav class="footer_nav">
          <ul>
            ...
            <li><a class="strength" href="<?php echo esc_url(home_url('#strength')); ?>">Strength</a></li>
            <li><a href="<?php echo esc_url(home_url('#contact')); ?>">Contact</a></li>
          </ul>
        </nav>
      </div>
    </div>
    <p class="copyright">Copyright &copy; 2023 Ogawa Yasuhiro All Rights Reserved.</p>
